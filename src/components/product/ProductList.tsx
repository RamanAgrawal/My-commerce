...
import { fetchProductsByFiltersAsync, selectAllProducts, ProductData, selectTotalItems } from './ProductSlice'
...
const ProductList: FC = () => {
    ...
    const HandleFilter = (e: ChangeEvent<HTMLInputElement>, section: Filter, option: FilterOptions) => {
...
interface FilterProps {
    HandleFilter: (e: React.ChangeEvent<HTMLInputElement>, section: Filter, option: FilterOptions) => void;
}
const DesktopFilters: FC<FilterProps> = ({ HandleFilter }) => {
...
const MobileFilters: FC<MobileFiltersProps> = ({ mobileFiltersOpen, setMobileFiltersOpen, HandleFilter }) => {
