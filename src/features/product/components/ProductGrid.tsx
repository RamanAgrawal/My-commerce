...
const ProductGrid: FC<ConnectedProductListProps> = ({ products }) => {
  ...
  return (
    <div className="lg:col-span-3 bg-white mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-0 lg:max-w-full lg:px-8">
      ...
      <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
        {products.map((product: ProductDataI) => (
          <div
            key={product.id}
            style={{ boxShadow: "rgba(218, 223, 225) 1px 2px 15px 0px" }}
            className="group relative p-5 rounded-md hover:scale-110"
          >
